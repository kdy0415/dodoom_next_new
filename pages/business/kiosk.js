            ...
            <div id="content">
                <div className="container">
                    ...
                    <div className="cate_tap kr">
                        ...
                        <Link href="/business/smartad"><span>스마트 광고 자동 판매 스테이션</span></Link>
                    ...
                    <div className="business_wrap">
                        <div className="business_box">
                            ...
                            <div className="kiosk_cnt">
                                ...
                                <div className="img_sub">&lt;키오스크 기계&gt;</div>
                                </div>
                        ...
                        <div className="business_box">
                            ...
                            <p>공항, 대학교, 공장 등에 설치될 예정(미국 애틀란타 Link Group International 과 수출 진행 중)</p>
                            <div className="img_list">
                                <div className="img_item">
